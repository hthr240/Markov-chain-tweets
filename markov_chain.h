...
typedef void (*gen_print)(const void *);
typedef int (*gen_cmp)(const void *, const void *);
typedef void (*gen_free)(const void *);
typedef void *(*gen_cpy)(const void *);
typedef bool (*gen_is_last)(const void *);
/***************************/
/*        STRUCTS          */
/***************************/
